...
CATALOG: list[tuple[str, str, int, str, int]] = [
    ...
    # 리컬러 헤어 (기본 머리 모양에 색 교체)
    ("hair", "벚꽃 핑크 머리", 55, "emoji:🌸", 50),
    ("hair", "반짝 금발", 55, "emoji:🌟", 50),
    ("hair", "은빛 머리", 60, "emoji:🤍", 50),
    ("hair", "하늘빛 머리", 60, "emoji:💙", 50),
    ("hair", "라벤더 머리", 60, "emoji:💜", 50),
    # ── 상의 (30) ──
    ...
    # 리컬러 티셔츠 라인 (기본 티셔츠 메시에 색만 교체 — 몸에 딱 맞는 다른 옷)
    ("top", "핑크 티셔츠", 28, "emoji:👕", 30),
    ("top", "민트 티셔츠", 28, "emoji:👕", 30),
    ("top", "노랑 티셔츠", 28, "emoji:👕", 30),
    ("top", "하늘 티셔츠", 28, "emoji:👕", 30),
    ("top", "블랙 티셔츠", 30, "emoji:👕", 30),
    ("top", "라벤더 티셔츠", 28, "emoji:👕", 30),
    # ── 하의 (20) ──
    ("bottom", "청바지", 30, "emoji:👖", 20),
    ("bottom", "반바지", 25, "emoji:🩳", 20),
    ("bottom", "튜튜 치마", 45, "emoji:🩰", 20),
    ("bottom", "핑크 반바지", 26, "emoji:🩳", 20),
    ("bottom", "하늘 반바지", 26, "emoji:🩳", 20),
    ("bottom", "화이트 반바지", 26, "emoji:🩳", 20),
    # ── 스페셜 세트: 프롭+리컬러 콤보 (32) ──
    ("set", "공룡 잠옷 세트", 95, "emoji:🦖", 32),
    ("set", "마녀 세트", 85, "emoji:🎃", 32),
    ("set", "로봇 히어로 세트", 115, "emoji:🤖", 32),
    ("set", "스파이더 히어로 세트", 115, "emoji:🕷️", 32),
    ("set", "천사 세트", 130, "emoji:👼", 32),
    ("set", "왕족 세트", 125, "emoji:👸", 32),
    ("set", "발레리나 세트", 95, "emoji:🦢", 32),
    # ── 원피스 (35) ──
    ...
    ("shoes", "핑크 스니커즈", 22, "emoji:👟", 10),
    ("shoes", "빨강 스니커즈", 22, "emoji:👟", 10),
    ("shoes", "하늘 스니커즈", 22, "emoji:👟", 10),
    ("shoes", "노랑 스니커즈", 22, "emoji:👟", 10),
    ("shoes", "화이트 스니커즈", 24, "emoji:👟", 10),
...
ASSET_REFS: dict[tuple[str, str], str] = {
    ...
    # 리컬러(틴트) 의류·헤어 — 'tint:<머티리얼프리픽스>:<hex>'
    ("top", "핑크 티셔츠"): "tint:Tops:#ff8fbe",
    ("top", "민트 티셔츠"): "tint:Tops:#8fe3c0",
    ("top", "노랑 티셔츠"): "tint:Tops:#ffdf6b",
    ("top", "하늘 티셔츠"): "tint:Tops:#9ad8ff",
    ("top", "블랙 티셔츠"): "tint:Tops:#3a3344",
    ("top", "라벤더 티셔츠"): "tint:Tops:#c9a8ff",
    ("bottom", "청바지"): "tint:Bottoms:#5b7fd0",
    ("bottom", "핑크 반바지"): "tint:Bottoms:#ff9ec4",
    ("bottom", "하늘 반바지"): "tint:Bottoms:#9ad8ff",
    ("bottom", "화이트 반바지"): "tint:Bottoms:#f2f2f2",
    ("shoes", "핑크 스니커즈"): "tint:Shoes:#ff8fbe",
    ("shoes", "빨강 스니커즈"): "tint:Shoes:#e23c3c",
    ("shoes", "하늘 스니커즈"): "tint:Shoes:#9ad8ff",
    ("shoes", "노랑 스니커즈"): "tint:Shoes:#ffdf6b",
    ("shoes", "화이트 스니커즈"): "tint:Shoes:#f5f5f5",
    ("hair", "벚꽃 핑크 머리"): "tint:Hair:#ffb3d1",
    ("hair", "반짝 금발"): "tint:Hair:#ffd98a",
    ("hair", "은빛 머리"): "tint:Hair:#d8dce8",
    ("hair", "하늘빛 머리"): "tint:Hair:#9ad8ff",
    ("hair", "라벤더 머리"): "tint:Hair:#c9a8ff",
    # 날개 (프롭 제작 완료로 재활성)
    ("wings", "천사 날개"): "prop:angel_wings",
    ("wings", "나비 날개"): "prop:butterfly_wings",
    # 스페셜 세트 — 'combo:*' (프롭+리컬러+숨김 묶음)
    ("set", "공룡 잠옷 세트"): "combo:dino",
    ("set", "마녀 세트"): "combo:witch",
    ("set", "로봇 히어로 세트"): "combo:robot_hero",
    ("set", "스파이더 히어로 세트"): "combo:spider_hero",
    ("set", "천사 세트"): "combo:angel",
    ("set", "왕족 세트"): "combo:royal",
    ("set", "발레리나 세트"): "combo:ballerina",
